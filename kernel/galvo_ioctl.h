...
struct galvo_ab_batch {
    struct galvo_ab *coords; /* 用户空间的坐标数组指针 */
    uint32_t count;          /* 坐标总数 */
    uint32_t interval_us;    /* hrtimer 触发间隔(微秒) */
};
...
#define GALVO_IOC_SET_BATCH _IOW(GALVO_IOC_MAGIC, 4, struct galvo_ab_batch)
